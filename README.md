...
```
sudo apt install awesome fonts-roboto rofi picom i3lock xclip qt5-style-plugins materia-gtk-theme lxappearance xbacklight kde-spectacle thunar xfce4-power-manager pnmixer network-manager network-manager-gnome -y
...
- [picom](https://github.com/yshui/picom) for the compositor (blur and animations) universal install: picom - Ubuntu (or Ubuntu based) users need PPA (`sudo add-apt-repository ppa:regolith-linux/unstable`)
...
```
git clone https://github.com/koytar67/my-material-awesome.git ~/.config/awesome
```
